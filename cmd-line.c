...
/**********************************************************************/
int getFlagParam( int argc, char **argv, char *arg_str, 
                  int *mark_arg ) {
/* 
...
/**********************************************************************/
int getStringParam( int argc, char **argv, char *arg_str, 
...
/**********************************************************************/
int getIntParam( int argc, char **argv, 
...
/**********************************************************************/
int getDoubleParam( int argc, char **argv, 
                    char *arg_str, int *mark_arg,
...
/**********************************************************************/
int getStringParamValidate( int argc, char **argv, char *arg_str, 
...
/**********************************************************************/
void showUsageEnumType( FILE *file, char *option_str, 
...
/**********************************************************************/
void parseVerboseModes( char *list ) {
/*
