...
/**********************************************************************/
int countNonZeroesAlpha( double *alpha, double epsilon ) {
/*
...
/**********************************************************************/
int countNonZeroesList( AlphaList list, double epsilon ) {
/*
...
/**********************************************************************/
int countNonZeroesDiff( double *alpha, AlphaList list, 
                        double epsilon ) {
/* 
   Just goes through each component of each vector in the list and
...
/**********************************************************************/
void setUpObjectiveFunction( LP lp ) {
/*
...
/**********************************************************************/
void setUpRegionConstraintsOld( LP lp, double *alpha, 
                                AlphaList orig_list ) {
/*
...
*/
  ...
  /* There are some sign changes that need to be done depending upon
     whether the POMDP immediate values represent rewards or costs.
     We set the adjust_factor once and just use it everywhere else. */
...
#endif
      {
        lp->matval[index] = adjust_factor * ( list->alpha[col] - alpha[col] );
        lp->matind[index++] = row;
      }
...
/**********************************************************************/
void addExtraVarColumn( LP lp, int col, int *index, double sign ) {
/*
  With the new LP region formaulation we need to add two extra LP
...
/**********************************************************************/
void setUpRegionConstraintsNew( LP lp, double *alpha, 
                                AlphaList orig_list ) {
/*
  Sets up all the constraints for this LP. Sets the coefficients in
  lp->matval, the sense, the RHS and the bookkeeping arrays
...
/**********************************************************************/
LP setUpRegionLP( double *alpha, AlphaList list, double sparse_epsilon ) {
...
/**********************************************************************/
int findRegionPoint( double *alpha, AlphaList list, 
