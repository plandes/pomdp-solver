...
/**********************************************************************/
I_Matrix_Row_Node newRowNode( int col, double value ) {
/*
...
/**********************************************************************/
double sumIMatrixRowValues( I_Matrix i_matrix, int row ) {
  double sum = 0.0;
...
Matrix newMatrix( int num_rows, int num_non_zero ) {
  ...
  matrix->mat_val = (double *) 
    calloc( num_non_zero, sizeof( double ));
  matrix->col = (int *) 
...
/**********************************************************************/
double sumRowValues( Matrix matrix, int row ) {
  double sum = 0.0;
  int col;
...
/**********************************************************************/
double getEntryMatrix( Matrix matrix, int row, int col ) {
/*
