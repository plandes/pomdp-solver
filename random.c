...
/**********************************************************************/
void getRandomSeed( unsigned short seed[SEED_SIZE] ) {
...
/**********************************************************************/
void setRandomSeed( unsigned short seed[SEED_SIZE] ) {
...
/**********************************************************************/
void displayRandomSeed( FILE *file ) {
/* 
...
void setRandomDistribution( double *x, int num_probs ) {
/* This routine sets the discrete probability distribution so that
...
/**********************************************************************/
void setRandomDoubleVector( double *vect, int num, 
