...
/**********************************************************************/
void relinkObsSources( AlphaList list ) {
/* 
...
/**********************************************************************/
int bestAlphaForBeliefQ( AlphaList node, double *b, 
...
/**********************************************************************/
int setBestAlphaForBeliefQ( double *b, AlphaList *projection,
                            double epsilon ) {
/*
...
/**********************************************************************/
int setBestAlphasForBeliefV( double *b, AlphaList **projection,
                             double epsilon ) {
/*
...
/**********************************************************************/
double oneStepValue( double *b, AlphaList **projection,
...
/**********************************************************************/
AlphaList makeAlphaVector( AlphaList new_alpha_list, 
                           AlphaList **projection,
...
/**********************************************************************/
AlphaList addVectorAtBeliefQ( AlphaList list, double *belief,
                              AlphaList *projection,
...
/*
  ...
  Retruns a pointer to the new node added.
*/
  AlphaList node;
...
/**********************************************************************/
int initWithSimplexCornersQ( AlphaList list, AlphaList *projection,
                             int save_witness_point,
                             double epsilon ) {
/*
...
/**********************************************************************/
int initWithRandomBeliefPointsQ( AlphaList list, int num_points,
                                 AlphaList *projection,
                                 int save_witness_point,
                                 double epsilon) {
/*
...
/**********************************************************************/
int initListSimpleQ( AlphaList list, AlphaList *projection,
