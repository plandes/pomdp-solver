...
/**********************************************************************/
void cleanUpIncPrune(  ) {

}  /* cleanUpCrossSum */
/**********************************************************************/
void clearAlphaListCounter( AlphaList list ) {
/*
...
/**********************************************************************/
void initializeCountersIp( AlphaList list ) {
/* 
...
/**********************************************************************/
void addSimpleSumIp( AlphaList new_list, 
                     AlphaList old_list, 
                     AlphaList add_node,
                     AlphaList skip_node ) {
/*
...
/**********************************************************************/
void addExtractedNodesIp( AlphaList new_list, 
                          AlphaList old_list,
...
/**********************************************************************/
AlphaList getGenIpCompareList( AlphaList node, 
...
/**********************************************************************/
AlphaList generalizedIpCrossSum( AlphaList A, AlphaList B, 
...
/**********************************************************************/
AlphaList improveIncPrune( AlphaList *projection, 
                          PomdpSolveParams param ) {
