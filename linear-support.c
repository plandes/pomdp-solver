...
void initLinSupport( ) {
  ...
  Assert( gValueType != COST_value_type,
          "Linear support currently only supports reward-based POMDPs.");
  
  initVertexEnum( gNumStates );
  
}  /* initLinSupport */
/**********************************************************************/
void cleanUpLinSupport( ) {
  
  cleanUpVertexEnum( );
  
}  /* cleanUpLinSupport */
/**********************************************************************/
int sameVertex( double *b1, double *b2, double epsilon ) {
   int i;
...
/**********************************************************************/
VertexList queryVertexList( VertexList list, double *vertex,
                             double epsilon ) {
...
/**********************************************************************/
void showLinSupportVertex( double *b, FILE *file ) {
   int i;
...
/**********************************************************************/
void showVertexList( VertexList list, FILE *file ) {
   int count = 0;
...
/**********************************************************************/
VertexList purgeVertexList( VertexList list ) {
...
/**********************************************************************/
VertexList addVertex( VertexList vertex_list, double *vertex,
                      unsigned int flags, double Hv_value ) {
   int i;
   VertexList new_node;

   new_node = (VertexList)malloc( sizeof( *new_node ));
   new_node->b = (double *)malloc( gNumStates * sizeof( double ));
...
/**********************************************************************/
void destroyVertexList( VertexList list ) {
   VertexList temp;
...
/**********************************************************************/
VertexList findVertices( VertexList vertex_list, 
                         AlphaList cur_alpha,
...
/**********************************************************************/
int calcHv( VertexList vertex_list, AlphaList **projection, 
            double  epsilon ) {
   VertexList list;
   AlphaList dummy;
...
/**********************************************************************/
VertexList calcError( VertexList vertex_list, 
                      AlphaList new_alpha_list, double epsilon ) {
...
/**********************************************************************/
AlphaList newSupportVertices( VertexList pi_hat, 
...
/**********************************************************************/
VertexList calcNewError( VertexList vertex_list, AlphaList cur_alpha ) {
   VertexList temp_ptr;
   double new_err;
   int i;
...
/**********************************************************************/
AlphaList improveLinSupport( AlphaList **projection,
