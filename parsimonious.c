...
/**********************************************************************/
int isEmptyRegionSimpleCheck( AlphaList list, 
                              double *alpha,
                              double epsilon,
...
/**********************************************************************/
void markBestAtSimplexVertices( AlphaList list, 
...
/**********************************************************************/
void markBestAtRandomPoints( AlphaList list, 
                             int num_points, 
                             int save_witness_points,
                             double epsilon ) {
/* 
...
/**********************************************************************/
int isEpsilonApproximation( AlphaList test_list,
                            AlphaList orig_list,
                            double *max_diff,
...
/**********************************************************************/
int epsilonPrune( AlphaList list, 
                  PomdpSolveParams param  ) {
/*
...
/**********************************************************************/
int dominationCheck( AlphaList orig_list ) {
/*
...
/**********************************************************************/
int normalPrune( AlphaList orig_list, PomdpSolveParams param ) {
/* 
...
/**********************************************************************/
void purgeAlphaList( AlphaList list, 
                     PurgeOption purge_option,
                     PomdpSolveParams param ) {
/*
...
/**********************************************************************/
void purgeProjections( AlphaList **projection, 
                       PomdpSolveParams param ) {
/*
