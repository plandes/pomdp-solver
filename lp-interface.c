...
/**********************************************************************/
void LP_setPrecision( double epsilon ) {
/*
...
/**********************************************************************/
void initLpInterface( PomdpSolveParams param ) {
/*
...
/**********************************************************************/
lprec *LP_make_lp( int rows, int columns, int non_zeroes ) {
/*
...
/**********************************************************************/
void LP_writeLpSolveLP( lprec *lp, char *filename ) {
/*
...
/**********************************************************************/
void LP_writeLpSolveSolution( lprec *lp, char *filename ) {
  char msg[MAX_MSG_LENGTH];
  FILE *file;
...
/**********************************************************************/
void LP_extractLpSolveSolution( LP lp ) {
/*
...
/**********************************************************************/
void LP_unloadLpSolveLP( lprec **lp ) {
...
/**********************************************************************/
LP LP_newLP( int rows, int cols, int non_zeroes ) {
/*
...
*/ 
  ...
  lp->name = (char *) calloc( strlen( DEFAULT_LP_NAME )+1, 
                              sizeof(char));
  ...
  /* When getting the solutions we need an arrary to hold the values
     ...
     the time. */
  lp->x = (double *)malloc( lp->cols * sizeof(double));
...
/**********************************************************************/
void LP_writeSolution( LP lp, char *filename ) {
/*
...
/**********************************************************************/
void LP_writeLP( LP lp, char *filename ) {
/*
...
/**********************************************************************/
int LP_solveLP( LP lp, SolutionStats stat ) {
/*
...
/**********************************************************************/
int LP_loadbase( LP lp, int *cstat, int *rstat  ) {
...
/**********************************************************************/
int LP_getgrad( LP lp, int j, int *ix, double *y  ) {
...
/**********************************************************************/
int LP_getx( LP lp, double *x, int begin, int end ) {
...
/**********************************************************************/
int LP_getslack( LP lp, double *slack, int begin, int end  ) {
...
/**********************************************************************/
int LP_getdj( LP lp,double *dj, int begin, int end ) {
...
/**********************************************************************/
int LP_getpi( LP lp, double *pi, int begin, int end ) {
...
/**********************************************************************/
int LP_getbase( LP lp, int *cstat, int *rstat ) {
...
/**********************************************************************/
int LP_setlpcallbackfunc(  int (*pcallback)(CPXLPptr lpinfo, 
                                            int wherefrom )  ) {
...
/**********************************************************************/
int LP_getobjval( LP lp, double *pobjval ) {
...
/**********************************************************************/
int LP_binvarow( LP lp, int row, double *coefs ) {
...
/**********************************************************************/
int LP_binvrow( LP lp, int row, double *coefs  ) {
