...
/**********************************************************************/
int addNeighbor( AlphaList list, double *neighbor,
...
/**********************************************************************/
int addAllNeighbors( AlphaList list, AlphaList node, 
                     AlphaList *projection,
                     int domination_check, double epsilon ) {
/*
...
/**********************************************************************/
int addAllNeighborsFromList( AlphaList dest_list, AlphaList list,
                             AlphaList *projection,
                             int domination_check,
                             double epsilon ) {
/*
