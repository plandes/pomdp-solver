...
/**********************************************************************/
AlphaList **allocateAllProjections(  ) {
/*
...
*/
  ...
  projection = (AlphaList **) malloc( gNumActions 
                                      * sizeof( *projection ));
  
  /* For each action, we need a projection for each  observation. */
  for ( a = 0; a < gNumActions; a++ )
    projection[a] = (AlphaList *) calloc( gNumObservations,
                                          sizeof( **projection ));
...
/**********************************************************************/
void clearAllProjections( AlphaList **projection ) {
/*
...
/**********************************************************************/
void freeAllProjections( AlphaList **projection ) {
  /*
...
/**********************************************************************/
AlphaList makeProjection(  AlphaList list, int a, int z ) {
/*
...
*/
  ...
  while ( list != NULL ) {
    ...
    /* Indicate which vector it originated from in list. */
    temp->prev_source = list;
...
/**********************************************************************/
void setAllProjections( AlphaList **projection,
...
/**********************************************************************/
AlphaList **makeAllProjections( AlphaList prev_alpha_list ) {
/*
  Makes all the projected alpha vector lists, which amounts to a
  projected list for each action-observation pair. Stores this as a
  two dimensional array of lists where the first index is the action
...
/**********************************************************************/
void displayProjections( FILE *file, AlphaList **projection ) {
/*
...
/**********************************************************************/
void showProjections( AlphaList **projection ) {
/*
