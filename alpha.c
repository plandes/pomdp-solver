...
*/
   return (  (double *) malloc( sizeof( double ) * gNumStates ));
}  /* newAlpha */
/**********************************************************************/
double *duplicateAlpha( double *alpha ) {
/*
...
/**********************************************************************/
void copyAlpha( double *dest, double *src ) {
/*
...
/**********************************************************************/
void destroyAlpha( double *alpha ) {
/*
...
/**********************************************************************/
int isZeroAlpha( double *alpha, double epsilon ) {
/* 
...
/**********************************************************************/
void displayAlpha( FILE *file, double *alpha ) {
/*
...
/**********************************************************************/
int isLexicographicallyBetterAlpha( double *first_alpha,
                                    double *second_alpha,
                                    double epsilon ) {
/* 
...
/**********************************************************************/
int isLexicographicallyBetter( AlphaList first_alpha,
...
/**********************************************************************/
int isDominatedVector( double *alpha1, double *alpha2 ) {
/* 
...
*/
  ...
  return ( (AlphaList *) calloc( gNumObservations,
                                 sizeof( *node ) ));
}  /* *newObsSourceArray */
/**********************************************************************/
AlphaList *duplicateObsSourceArray( AlphaList *orig_obs_source ) {
/*
...
/**********************************************************************/
AlphaList newAlphaNode( double *alpha, int action ) {
/*
...
*/
  ...
  temp = (AlphaList) malloc( sizeof( *temp ));
...
/**********************************************************************/
AlphaList newAlphaNodeObsSource( double *alpha, 
                                 int action ) {
  AlphaList node;
...
/**********************************************************************/
void destroyAlphaNode( AlphaList temp ) {
/*
...
/**********************************************************************/
void appendNodeToAlphaList( AlphaList list, AlphaList node ) {
/*
...
/**********************************************************************/
void prependNodeToAlphaList( AlphaList list, AlphaList node ) {
/*
...
/**********************************************************************/
AlphaList dequeueAlphaNode( AlphaList list ) {
/*
...
/**********************************************************************/
void enqueueAlphaNode( AlphaList list, AlphaList node ) {
/*
...
/**********************************************************************/
AlphaList duplicateAlphaNode( AlphaList node ) {
/*
...
/**********************************************************************/
AlphaList appendDuplicateNodeToAlphaList( AlphaList list, 
                                          AlphaList orig_node ) {
/*
...
/**********************************************************************/
void addWitnessToAlphaNode( AlphaList node, double *witness ) {
/*
...
*/
  ...
  /* If there is an existing witness point, first free this memory. At
     the moment I canot think of why this might happen, but it certainly
     doesn't hurt. */ 
  if ( node->witness != NULL )
    free ( node->witness );

  node->witness = (double *)malloc( gNumStates * sizeof( double ));
...
/**********************************************************************/
void initAlphaList( AlphaList list ) {
/*
...
*/
  ...
  list = (AlphaList) malloc( sizeof( *list ));
  initAlphaList( list );
  
  return ( list );
}  /* newAlphaList */
/**********************************************************************/
void renumberAlphaList( AlphaList list ) {
/*
...
/**********************************************************************/
AlphaList prependAlphaList( AlphaList list,
                             double *alpha,
                             int action ) {
/*
...
/**********************************************************************/
AlphaList appendAlphaList( AlphaList list,
                            double *alpha,
                            int action ) {
/*
...
/**********************************************************************/
void clearAlphaList( AlphaList orig_list ) {
/*
...
/**********************************************************************/
void destroyAlphaList( AlphaList list ) {
/*
...
/**********************************************************************/
double bestVectorValuePrimed( AlphaList list, 
                              double *belief_state,
                              AlphaList *best_ptr,
...
*/
  ...
  *best_ptr = NULL;
  ...
  while( list != NULL ) {
    ...
    else if ( isBetterValue( cur_value, cur_best_value,
                             epsilon )) {
      cur_best_value = cur_value;
      *best_ptr = list;
    }
...
/**********************************************************************/
double bestVectorValue( AlphaList list, 
                        double *belief_state,
                        AlphaList *best_ptr,
                        double epsilon ) {
/*
...
/**********************************************************************/
AlphaList bestVectorPrimed( AlphaList list, 
                            double *belief_state, 
                            double *best_value,
                            double initial_value,
                            double epsilon ) {
...
/**********************************************************************/
AlphaList bestVector( AlphaList list, 
                      double *belief_state,
                      double *best_value,
                      double epsilon ) {
  /*
...
/**********************************************************************/
AlphaList findAlphaVector( AlphaList list, double *alpha,
                           double epsilon ) {
/*
...
/**********************************************************************/
int queryAlphaList( AlphaList list, 
                    double *alpha,
                    double epsilon ) {
/*
...
/**********************************************************************/
int sizeAlphaList( AlphaList list ) {
/*
...
/**********************************************************************/
void copyAlphaList( AlphaList dest_list,
                    AlphaList src_list ) {
/*
...
/**********************************************************************/
AlphaList duplicateAlphaList( AlphaList src_list ) {
/* 
...
/**********************************************************************/
int sameAlphaList( AlphaList l1, AlphaList l2, double epsilon ) {
/* 
...
/**********************************************************************/
int similarAlphaList( AlphaList list1, AlphaList list2,
                      double epsilon ) {
/*
...
/**********************************************************************/
void displayAlphaList( FILE *file, AlphaList list ) {
/*
...
*/
  ...
  while(list != NULL ) {
    ...
    fprintf(file, "\t[%d] ", list->id );
    displayAlpha(file, list->alpha );
    fprintf(file, " <a=%d z=%d", list->action, list->obs );
...
/**********************************************************************/
void showAlphaList( AlphaList list ) {
/*
...
/**********************************************************************/
AlphaList readAlphaList( char *filename, int max_alphas ) {
/*
...
/**********************************************************************/
void writeAlphaList( AlphaList list, char *filename ) {
/*
...
/**********************************************************************/
void unionTwoAlphaLists( AlphaList list, AlphaList other_list ) {
/*
...
/**********************************************************************/
void clearObsSourceAlphaList( AlphaList list ) {
/*
...
/**********************************************************************/
AlphaList appendUniqueAlphaList( AlphaList list,
                                  double *alpha,
                                  int action, double epsilon ) {
/*
...
/**********************************************************************/
int dominatedAlphaList( double *alpha, AlphaList list ) {
/*
...
/**********************************************************************/
void clearMarkAlphaList( AlphaList list ) {
/*
...
/**********************************************************************/
int sizeUnmarkedAlphaList( AlphaList list ) {
/*
...
/**********************************************************************/
int allMarkedAlphaList( AlphaList list ) {
/*
...
/**********************************************************************/
AlphaList findUnmarkedVector(  AlphaList list ) {
/* 
...
/**********************************************************************/
AlphaList extractUnmarkedVector( AlphaList list ) {
/*
...
/**********************************************************************/
int markDominatedAlphaList( double *alpha, AlphaList list ) {
/*
...
/**********************************************************************/
AlphaList extractMarkedAlphaList( AlphaList list ) {
/*
...
/**********************************************************************/
int removeMarkedAlphaList( AlphaList list ) {
/*
  Removes all the nodes which have their 'mark' fields set to TRUE.
...
/**********************************************************************/
AlphaList extractAlphaNode( AlphaList list, AlphaList extract_ptr ) {
/*
...
/**********************************************************************/
AlphaList removebestVectorNode( AlphaList list, double *b, 
                                double epsilon ) {
/*
...
/**********************************************************************/
AlphaList extractFromAlphaList( AlphaList list, double *alpha, 
                                double epsilon ) {
/*
...
/**********************************************************************/
int removeFromAlphaList( AlphaList list, double *alpha,
                         double epsilon ) {
/*
...
/**********************************************************************/
void swapPointersAlphaList( AlphaList *x, AlphaList *y ) {
  AlphaList temp;
...
/**********************************************************************/
void quicksortAlphaList( AlphaList *array, int left, int right ) {
/* 
...
/**********************************************************************/
void sortAlphaList( AlphaList list ) {
/*
...
*/
  ...
  array = (AlphaList *) malloc( list->length * sizeof( *array ));
...
/**********************************************************************/
int maxSizeAlphaLists( AlphaList *list, int num_lists ) {
/*
